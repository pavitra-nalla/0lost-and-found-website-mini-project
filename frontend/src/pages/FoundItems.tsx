  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="font-display font-semibold text-3xl text-foreground mb-2">Found Items</h1>
        <p className="text-muted-foreground mb-8">Browse items that have been found and reported.</p>
